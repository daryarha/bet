...
<div class="row">
	<div class="col-md-4 col-md-offset-4"><input type="password" name="password" placeholder="Password"></div>
</div>

<center><button type="submit" class="btn btn-lg btn-blue">Login</button></center><br>
Note: Fill your delegation biodata after login.<br>
</form>
</div>
