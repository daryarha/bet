...
<?php echo form_open_multipart('user/edit/'.$peserta2.'/'.$category['id']); ?>
	<center><p class="judul"><?php echo $category['nama'];?> Delegation<br> Edit Biodata</p></center><br>
		...
		<?php }else{ ?>
		<div id="sns">
				<input type="text" name="id" placeholder="Id" value="<?php echo $peserta['id'];?>" style="display: none;">
			<div class="row">
				<div class="col-md-6"><input type="text" name="nama" placeholder="Full Name" value="<?php echo $peserta['nama_peserta'];?>"></div>
				<div class="col-md-6"><input type="file" name="foto"/>Upload your student card photo.<br>If you are not changing student card photo please do not upload twice.</div>
			</div>
			<div class="row">
				<div class="col-md-6"><input type="text" name="no_telp" placeholder="Phone" value="<?php echo $peserta['phone'];?>"></div>
				<div class="col-md-6"><input type="text" name="alergi" placeholder="Food Allergy" value="<?php echo $peserta['alergi'];?>"></div>
			</div>
			<center><button type="submit" class="btn btn-lg btn-blue">Save changes</button></center>
		</div>
		<?php } ?>
